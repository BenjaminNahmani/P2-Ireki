			...
			<fieldset>
				...
				<p>
					...
					<?php
						...
						if( 1 == $fhw_dsgvo_cookie_position ) $fhw_dsgvo_cookie_position_selection1 = "selected";
						if( 2 == $fhw_dsgvo_cookie_position ) $fhw_dsgvo_cookie_position_selection2 = "selected";
					?>
					<select name="fhw_dsgvo_cookie_position">
						<option value="1" <?php echo $fhw_dsgvo_cookie_position_selection1; ?>><?php _e('Top', 'dsgvo-tools-cookie-hinweis-datenschutz') ?></option>
						<option value="2" <?php echo $fhw_dsgvo_cookie_position_selection2; ?>><?php _e('Bottom', 'dsgvo-tools-cookie-hinweis-datenschutz') ?></option>
					</select>
				</p>
				<p>
				...
				<p>
					...
					<input type="text" class="color-picker" name="fhw_dsgvo_cookie_textcolor" value="<?php echo esc_attr( get_option( 'fhw_dsgvo_cookie_textcolor', "#ff0000" ) ); ?>" />
				</p>
                <?php
				...
				<p>
					...
					<?php
						...
						if( 1 == $fhw_dsgvo_cookie_position ) $fhw_dsgvo_cookie_datenschutz_selection1 = "selected";
						if( 2 == $fhw_dsgvo_cookie_position ) $fhw_dsgvo_cookie_datenschutz_selection2 = "selected";
					?>
					<select name="fhw_dsgvo_cookie_datenschutzerklaerung">
						<option value="1" <?php echo $fhw_dsgvo_cookie_datenschutz_selection1; ?>><?php _e( 'Yes', 'dsgvo-tools-cookie-hinweis-datenschutz' ) ?></option>
						<option value="2" <?php echo $fhw_dsgvo_cookie_datenschutz_selection2; ?>><?php _e( 'No', 'dsgvo-tools-cookie-hinweis-datenschutz' ) ?></option>
					</select>
				</p>
				<p>
					...
					<?php
						...
						if( 1 == $fhw_dsgvo_cookie_design ) $fhw_dsgvo_cookie_design_selection1 = "selected";
						if( 2 == $fhw_dsgvo_cookie_design ) $fhw_dsgvo_cookie_design_selection2 = "selected";
					?>
						<select name="fhw_dsgvo_cookie_datenschutzdesign">
							<option value="1" <?php echo $fhw_dsgvo_cookie_design_selection1; ?>><?php _e( 'Hyperlink', 'dsgvo-tools-cookie-hinweis-datenschutz' ) ?></option>
							<option value="2" <?php echo $fhw_dsgvo_cookie_design_selection2; ?>><?php _e( 'Button', 'dsgvo-tools-cookie-hinweis-datenschutz' ) ?></option>
						</select>
				</p>
				<p id='ppbtnbg'>
